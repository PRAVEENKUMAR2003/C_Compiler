...
variable_declaration
			: datatype variables ';' 
			| structure_initialize  {printf("found structure init variable_declaration\n");};

structure_initialize 
			: STRUCT identifier variables ';' {printf("structure_initialize\n");};
...
parameters 
			...
			| STRUCT identifier all_parameter_identifiers {printf("hey ya\n");}
